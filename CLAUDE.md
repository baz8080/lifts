...
| Every drill-down links to its static page from its own line under the heading; the wording is per site because it must match the content relationship, and lifts' page is the same content as the view, so its label names the address rather than the content | `notes/site.md` § The permalink affordance moved out of the footer |

...
| A lost verdict names the platforms that never needed the lift ("kept step-free access", quoting the prose) - derived per sentence, never for lift-served or notice-named platforms, never at a general lift claim, and worded apart from the reviewed same-platform alternatives | `notes/station-access.md` § The other platform is often still step-free |
